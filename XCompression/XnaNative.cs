    ...
    internal static class XnaNative
    {
        ...
        public struct NativeInfo
        {
                ...
                IntPtr destroyDecompressionContextAddress)
            {
                ...
                Version = version;
                Hash = hash;
                CreateCompressionContextAddress = createCompressionContextAddress;
                CompressAddress = compressAddress;
                DestroyCompressionContextAddress = destroyCompressionContextAddress;
                CreateDecompressionContextAddress = createDecompressionContextAddress;
                DecompressAddress = decompressAddress;
                DestroyDecompressionContextAddress = destroyDecompressionContextAddress;
            }
